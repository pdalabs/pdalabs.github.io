const githubUsername = "pdalabs";
const repoName = "data";
const fileDirectory = "files";
const branch = "main";
let ascii_codes = [103, 104, 112, 95, 71, 112, 52, 108, 52, 80, 85, 90, 106, 116, 106, 53, 72, 122, 85, 72, 57, 66, 120, 82, 99, 52, 118, 99, 53, 90, 99, 111, 68, 77, 52, 73, 82, 84, 86, 65];
